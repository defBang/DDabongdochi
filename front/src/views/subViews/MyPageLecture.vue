  ...
  <div class="mypage_postDetail">
    <div class="mypage_postInfo">
      <b-row>
        ...
        <b-col class="mypage_postLecturerInfo" sm="auto"> 강의자 </b-col>
        <b-col class="mypage_postPlatformInfo" sm="auto"> 플랫폼 </b-col>
...
<script>
import Postlist from "../../components/MyPageList_Lecture.vue";
export default {
  props: {
    postsInfo: {
      type: Object,
