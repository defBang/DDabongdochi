<template>
  <div class="postDetail">
    <div
      ...
      :key="post.answer_post_id"
      class="Postlist"
    >
      <Postlist :answer="post" :isRecommended="isRecommended"> </Postlist>
    </div>
    <div class="pagebar">
      <b-button-group>
...
<script>
import Postlist from "../../components/MyPageList_Answer.vue";
export default {
  props: {
    postsInfo: {
      type: Object,
